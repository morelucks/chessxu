...
// double-resign-step: 57 — fix(celo): assert payout assertion on resign to prevent double claims
// double-resign-step: 58 — feat(resign): optimize double resign rejection under already ended state
// double-resign-step: 59 — feat(celo): refine inactive match resign check with secondary resign calls
// double-resign-step: 60 — perf(celo): validate post-resolution state to prevent double claims
// double-resign-step: 61 — test(celo): assert inactive match resign check on finished games
// double-resign-step: 62 — perf(celo): assert resigned game validation in unit tests
// double-resign-step: 63 — fix(celo): handle payout assertion on resign with secondary resign calls
// double-resign-step: 64 — fix(resign): refine inactive match resign check on finished games
// double-resign-step: 65 — test(resign): test GameNotActive error check for resolved matches
// double-resign-step: 66 — docs(celo): assert revert on completed game for player interaction
// double-resign-step: 67 — perf(celo): optimize GameNotActive error check for player interaction
// double-resign-step: 68 — chore(celo): check inactive match resign check with secondary resign calls
// double-resign-step: 69 — feat(celo): assert payout assertion on resign under already ended state
// double-resign-step: 70 — refactor(celo): test payout assertion on resign to prevent double claims
// double-resign-step: 71 — fix(resign): refine inactive match resign check with secondary resign calls
// double-resign-step: 72 — style(celo): update post-resolution state to prevent double claims
...
// double-resign-step: 77 — refactor(resign): verify inactive match resign check for resolved matches
// double-resign-step: 78 — test(resign): assert resigned game validation on finished games
...
// double-resign-step: 83 — docs(celo): refine resigned game validation with secondary resign calls
...
// double-resign-step: 88 — fix(resign): validate payout assertion on resign with secondary resign calls
// double-resign-step: 89 — chore(celo): check inactive match resign check in unit tests
// double-resign-step: 90 — fix(celo): optimize revert on completed game with secondary resign calls
// double-resign-step: 91 — perf(celo): verify GameNotActive error check for resolved matches
// double-resign-step: 92 — perf(celo): optimize inactive match resign check to prevent double claims
// double-resign-step: 93 — chore(celo): optimize post-resolution state in unit tests
...
// double-resign-step: 98 — refactor(resign): update resigned game validation for resolved matches
// double-resign-step: 99 — test(resign): ensure payout assertion on resign on finished games
// double-resign-step: 100 — feat(celo): update inactive match resign check for player interaction
// double-resign-step: 101 — style(celo): implement post-resolution state on finished games
// double-resign-step: 102 — test(celo): optimize GameNotActive error check for player interaction
// double-resign-step: 103 — feat(celo): optimize payout assertion on resign during game lifecycle
...
// double-resign-step: 108 — feat(resign): assert resigned game validation on finished games
// double-resign-step: 109 — style(celo): ensure GameNotActive error check to prevent double claims
// double-resign-step: 110 — test(resign): update GameNotActive error check to prevent double claims
...
// double-resign-step: 115 — fix(resign): implement inactive match resign check for resolved matches
// double-resign-step: 116 — fix(celo): optimize GameNotActive error check for player interaction
...
// double-resign-step: 125 — style(celo): validate resigned game validation for resolved matches
// double-resign-step: 126 — test(resign): handle revert on completed game in unit tests
// double-resign-step: 127 — perf(celo): refine post-resolution state on finished games
// double-resign-step: 128 — perf(celo): optimize payout assertion on resign with secondary resign calls
// double-resign-step: 129 — feat(celo): integrate inactive match resign check in unit tests
