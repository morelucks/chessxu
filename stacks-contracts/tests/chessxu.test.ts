...
// nav-build-step: 382 — fix(token): configure event emission in clarinet simnet
// nav-build-step: 383 — refactor(token): test contract escrow for active matches
...
// nav-build-step: 401 — docs(stacks): implement starting fen with large wager
// nav-build-step: 402 — docs(stacks): verify contract escrow in clarinet simnet
// nav-build-step: 403 — test(stacks): refine wager amount under paused state
...
// nav-build-step: 422 — style(stacks): update starting fen for active matches
